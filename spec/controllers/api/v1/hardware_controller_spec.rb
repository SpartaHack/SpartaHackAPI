...
RSpec.describe Api::V1::HardwareController, type: :controller do
  ...
  # HardwareController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new hardware" do

        post :create, params: {hardware: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(hardware_url(Hardware.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new hardware" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the hardware" do
        hardware = Hardware.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the hardware" do
        hardware = Hardware.create! valid_attributes
